    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                ...
                <!-- Botão de Logout -->
                <a href="logout.php" class="btn btn-danger" style="margin-left: 60rem;">Sair</a>
                            ...
                            <?php while ($cliente = $clientes->fetch_assoc()): ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="deletar_usuario.php?id=<?php echo $cliente['id']; ?>"
                        ...
                        <tbody>
                            <?php while ($funcionario = $funcionarios->fetch_assoc()): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="editar_usuario.php?id=<?php echo $funcionario['id']; ?>"
                                            class="btn btn-primary">Editar</a>
                                        <a href="deletar_usuario.php?id=<?php echo $funcionario['id']; ?>"
                                            class="btn btn-danger"
                                            onclick="return confirm('Tem certeza que deseja deletar?')">Deletar</a>
                                    </td>
                                </tr>
